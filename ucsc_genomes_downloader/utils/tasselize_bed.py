...
__all__ = ["tasselize_bed"]


def _tasselize_bed(chrom: str, chromStart: int, chromEnd: int, window_size: int) -> pd.DataFrame:
    """Return tasselized pandas dataframe splitting given window.
...
def aligned_tasselize_bed(chrom: str, chromStart: int, chromEnd: int, window_size: int, alignment: str) -> pd.DataFrame:
    """Return tasselized pandas dataframe splitting given window considering given alignment.
...
def _aligned_tasselize_bed(args: Tuple) -> pd.DataFrame:
    return aligned_tasselize_bed(*args)


def tasselize_bed(bed: pd.DataFrame, window_size: int, alignment: str = "left", verbose: bool = True) -> pd.DataFrame:
    """Return tasselized pandas dataframe splitting given window considering given alignment.
